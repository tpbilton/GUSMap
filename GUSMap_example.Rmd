...
## using optim 
MK_fs$rf_est(method="optim", mapped = FALSE)
## should be 76.09481
sum(GUSMap:::mfun(MK_fs$.__enclos_env__$private$para$rf_p[[1]],fun = "haldane", centiM = T)) 
MK_fs$.__enclos_env__$private$para$ep[[1]]
## should be 0.003167973
######
## using EM algorithm
MK_fs$rf_est(method="EM", mapped = FALSE)
## should be 76.09481
sum(GUSMap:::mfun(MK_fs$.__enclos_env__$private$para$rf_p[[1]],fun = "haldane", centiM = T))
## should be 0.003167973
MK_fs$.__enclos_env__$private$para$ep[[1]]                 
...
```{r}
simData$rf_est(method="optim", mapped = FALSE)
## Chromosome 1
## Should be 98.41231
sum(GUSMap:::mfun(simData$.__enclos_env__$private$para$rf_p[[1]],fun = "haldane", centiM = T))
## 0.01010545
simData$.__enclos_env__$private$para$ep[[1]]                 ## 0.01010545
## Chromosome 2
## Should be 103.2207
sum(GUSMap:::mfun(simData$.__enclos_env__$private$para$rf_p[[2]],fun = "haldane", centiM = T))
## 0.009815709
simData$.__enclos_env__$private$para$ep[[2]]
```
